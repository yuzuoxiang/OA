...
namespace OA.Core.Crypt
{
    public class WebKey
    {
        ...
        {
            return Tools.Encryption.EncryptionHelper.Md5(siteKeyCode + id, 32).Substring(0, 8);
        }
        ...
        public bool KeyCheck(string key, string checkCode)
        {
            ...
            return (Tools.Encryption.EncryptionHelper.Md5(siteKeyCode + id, 32).Substring(0, 8) == checkCode)
                ? true
                : false; 
        }
