    ...
    public class UnCodebase
    {
            ...
            for (int i = 0; i < bmpobj.Height; i++)
            {
                for (int j = 0; j < bmpobj.Width; j++)
                {
                    if (i < borderWidth || j < borderWidth || j > bmpobj.Width
                     - 1 - borderWidth || i > bmpobj.Height - 1 - borderWidth)
        ...
        public void GrayByLine()
        {
            ...
            for (int i = 0; i < len; i++)
            {
                ...
                pixels[i] = (byte)(Color.FromArgb(GrayValue, GrayValue,
        ...
        public Bitmap GetPicValidByValue(Bitmap singlepic, int dgGrayValue)
        {
            ...
            //复制新图
            Rectangle cloneRect = new Rectangle(posx1, posy1, posx2 - posx1 + 1,
             posy2 - posy1 + 1);
