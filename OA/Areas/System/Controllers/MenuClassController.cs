...
namespace OA.Areas.System.Controllers
{
    public class MenuClassController : BaseClassController<Mng_MenuClass>
    {
        ...
        public override ActionResult List()
        {
            ...
            if (id > 0)
                model = Bll.BllSys_MenuClass.Instance().First(o => o.Id == id);
        ...
        public override ActionResult Update()
        {
            ...
            Mng_MenuClass mod_ManageClass = Bll.BllSys_MenuClass.Instance().First(o => o.Id == id);
            ...
            else
            {
                mod_ManageClass.ClassName = className;
                mod_ManageClass.Url = url;
                Bll.BllSys_MenuClass.Instance().Update(mod_ManageClass, o => o.Id == id);
