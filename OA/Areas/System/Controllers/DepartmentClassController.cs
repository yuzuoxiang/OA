...
namespace OA.Areas.System.Controllers
{
    public class DepartmentClassController : BaseClassController<Mng_DepartmentClass>
    {
        ...
        public override ActionResult List()
        {
            ...
            if (id > 0)
                model = Bll.BllMng_DepartmentClass.Instance().First(o => o.Id == id);
        ...
        public override ActionResult Update()
        {
            ...
            {
                mod_ManageClass.ClassName = className;
                Bll.BllMng_DepartmentClass.Instance().Update(mod_ManageClass, o => o.Id == id);
